...
path_trained_model = os.getcwd() + r"\Trained_models\trained_model_lstm_rnn.pt"  # Path to trained model
...
num_of_sample_targets_per_series = 250  # Number of samples (and corresponding targets) per complete data series
