...
# Paths
path_train_data = "data/NDBC - Train/44040h2008.csv"  # Path to training dataset
path_test_data = "data/NDBC - Train/44040h2008.csv"  # Path to test dataset
path_trained_model = "Trained_models/trained_model_lstm_rnn.pt"  # Path to trained model
...
lookforward = 100  # Input dimension if prediction_mode is "fill_gap"
num_of_sample_targets_per_series = 100  # Number of samples (and corresponding targets) per complete data series
...
series_prediction_start = 1000  # The starting point of the test dataset to predict from
